...
export class SerieRepositoryImpl implements SerieRepository {
  constructor(
    @InjectRepository(SerieOrmEntity) private readonly repo: Repository<SerieOrmEntity>,
    @InjectRepository(SerieAuditoriaOrmEntity) private readonly auditoriaRepo: Repository<SerieAuditoriaOrmEntity>,
) {}
