...
import { CreateUsersUseCase } from 'src/application/auth/usuario/create-users.usecase';
import { GetUsuarioByIdUseCase } from 'src/application/auth/usuario/get-users-by-id.usecase';
import { GetUsersUseCase } from 'src/application/auth/usuario/get-users.usecase';
import { UpdateUsersUseCase } from 'src/application/auth/usuario/update-users.usecase';
...
@Controller('companies/branch/users')
export class UsuarioController {
  ...
  create(@Body() dto: CreateUsuarioDto) {
    try {
      const result = this.createUseCase.execute(dto);
      return result;
    } catch (error) {
