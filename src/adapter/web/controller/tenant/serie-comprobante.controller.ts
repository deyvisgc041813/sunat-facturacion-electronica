...
import { CreateSerieComprobanteUseCase } from 'src/application/tenant/serie-comprobante/create.serie.usecase';
...
import { GetByIdSerieComprobanteBySucursalUseCase } from 'src/application/tenant/serie-comprobante/get-by-id-serie-sucursal.usecase';
import { GetSerieComprobanteBySucursalUseCase } from 'src/application/tenant/serie-comprobante/get.series.usecase';
import { UpdateSerieComprobanteUseCase } from 'src/application/tenant/serie-comprobante/update.serie.usecase';
import { AdjustCorrelativeSerieComprobanteUseCase } from 'src/application/tenant/serie-comprobante/update.serie-correlativo.usecase';
import { UpdateStatusSerieComprobanteUseCase } from 'src/application/tenant/serie-comprobante/update-status.series.usecase';
import { DeleteSeriesComprobanteUseCase } from 'src/application/tenant/serie-comprobante/delete.sucursal.usecase';
...
@Controller('companies/branch/serie')
