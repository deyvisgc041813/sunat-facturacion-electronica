...
import { UbigeoRepositoryImpl } from 'src/infrastructure/persistence/parent/implement/ubigeo.repository.impl';
import {
...
export class UbigeoService {
 ...
 async getDistritoById(
    distritoId: number,
  ): Promise<DistritoResponseDto | null> {
    return await this.ubigeoRepo.getDistrictById(distritoId);
  }
