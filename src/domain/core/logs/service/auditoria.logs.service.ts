...
import { AuditoriaLogsRepositoryImpl } from 'src/infrastructure/persistence/core/logs/auditoria-log.repository';
import { ICreateAuditoriaLog } from '../dto/create.request.auditoria-logs';
import { AuditoriaLogsResponseDto } from '../dto/auditoria-logs.response';
@Injectable()
