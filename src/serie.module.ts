  ...
  providers: [
    {
      ...
      useFactory: (serieRepo: SerieComprobanteRepositoryImpl, catalogo:CatalogoRepositoryImpl, auditoriaService: AuditoriaService) =>
        new SerieComprobanteService(serieRepo, catalogo, auditoriaService),
      inject: [SerieComprobanteRepositoryImpl, CatalogoRepositoryImpl, AuditoriaService],
    },
    // Casos de uso
    {
